...
*** init-ai.el
AI feature-module entry point: package declarations, gptel backends, and keybindings. Implementation lives in site-lisp/omy-ai.el.
...
*** omy-ai.el
AI agent glue layer: session management, context injection, workflow commands.
